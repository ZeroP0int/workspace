			...
			<div class="concent">
				...
				<div class="paycont">
                   ...
                   <span class="buy-user">${address.name } </span>
							...
							<script>
							function sendAddress(index,addressid){
								...
								<div class="bundle  bundle-last">
									...
									<div class="bundle-main">
										<ul class="item-content clearfix">
												...
												<li class="td td-item">
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img src="/img/${requestScope.commodity.img }" width="80" height="80"  class="itempic J_ItemImg"></a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
															<a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11">${requestScope.commodity.cname }</a>
														</div>
													</div>
												</li>
												<li class="td td-info">
													<div class="item-props">
														<span class="sku-line">口味：${requestScope.fname }</span>
													</div>
												</li>
												<li class="td td-price">
													<div class="item-price price-promo-promo">
														<div class="price-content">
															<em class="J_Price price-now">${requestScope.promotional_price }</em>
														</div>
													</div>
												</li>
											</div>
											<li class="td td-amount">
												<div class="amount-wrapper ">
													<div class="item-amount ">
														...
														<div class="sl">
															${requestScope.commodity.quantity }
														</div>
													</div>
												</div>
											</li>
											<li class="td td-sum">
												<div class="td-inner">
													<em tabindex="0" class="J_ItemSum number">${requestScope.commodity.quantity*requestScope.commodity.promotional_price}</em>
												</div>
											</li>
							...
							<div class="order-extra">
								<div class="order-user-info">
									<div id="holyshit257" class="memo">
										...
										<input type="hidden" name="totalPrice" value="${requestScope.commodity.totalMoney }">
										<input type="hidden" name="address_Id" id="address_Id" value="0">
										<input type="hidden" name="cartIds" value="${requestScope.commodity.cartIds }">
