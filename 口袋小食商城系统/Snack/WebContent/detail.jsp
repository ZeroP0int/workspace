...
<div class="scoll">
  <section class="slider">
    <div class="flexslider">
      <ul class="slides">
        <li> <img  src="/img/${commodity.img }"> </li>
...
<div class="item-inform">
  <div class="clearfixLeft" id="clearcontent">
    <div class="box"> 
      ...
      <div class="tb-booth tb-pic tb-s310"> <a href="/img/${commodity.img }"><img src="/img/${commodity.img }" alt="细节展示放大镜特效" rel="/img/${commodity.img }" class="jqzoom" /></a> </div>
      <ul class="tb-thumb" id="thumblist">
       
       <li class="tb-selected">
          <div class="tb-pic tb-s40"> <a href="#"><img src="/img/${commodity.img }" mid="/img/${commodity.img }" big="/img/${commodity.img }"></a> </div>
        </li>
 <li>
          <div class="tb-pic tb-s40"> <a href="#"><img src="/img/${commodity.img }" mid="/img/${commodity.img }" big="/img/${commodity.img }"></a> </div>
        </li>
  ...
  <div class="clearfixRight"> 
            ...
            <form class="theme-signin" name="loginform" action="" method="post">
              <div class="theme-signin-left">
                <div class="theme-options">
                  ...
                  <ul>
                  <c:forEach items="${requestScope.commodity.flavorList}" var="flavor">
                ...
                <div class="theme-options">
                  ...
                  <c:forEach items="${requestScope.commodity.flavorList}" var="flavor">
                  <span id="Stock" class="tb-hidden">库存<span class="stock">${flavor.stock }</span>件</span>
                  </c:forEach> 
                </div>
    ...
    <div class="pay">
      ...
      <li>
        <div class="clearfix tb-btn tb-btn-buy theme-login"> <a id="LikBuy" title="点此按钮到下一步确认购买信息" href="javascript:pay(${requestScope.commodity.commodity_id })">立即购买</a> </div>
      </li>
      <li>
...
function pay(cid){
   ...
   location.href="DirectPayServlet?quantity="+quantity+"&fid="+fid+"&cid="+cid;
}

</script>
<input type="hidden" id="flavor_id" value=0>
<!-- introduce-->
