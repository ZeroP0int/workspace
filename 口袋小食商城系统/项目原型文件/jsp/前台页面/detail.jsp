...
<body>
<iframe src="header.html" width="100%" height="120px" frameborder="0" scrolling="no"></iframe>
<div class="listMain">
...
<div class="item-inform">
  <div class="clearfixLeft" id="clearcontent">
    <div class="box"> 
      ...
      <div class="tb-booth tb-pic tb-s310"> <a href="images/01.jpg"><img src="images/01_mid.jpg" alt="细节展示放大镜特效" rel="images/01.jpg" class="jqzoom" /></a> </div>
  ...
  <div class="clearfixRight"> 
    ...
    <div class="pay">
      <div class="pay-opt"> <a href="home.html"><span class="am-icon-home am-icon-fw">首页</span></a> <a><span class="am-icon-heart am-icon-fw">收藏</span></a> </div>
      <li>
        <div class="clearfix tb-btn tb-btn-buy theme-login"> <a id="LikBuy" title="点此按钮到下一步确认购买信息" href="pay.html">立即购买</a> </div>
      </li>
      <li>
        <div class="clearfix tb-btn tb-btn-basket theme-login"> <a id="LikBasket" title="加入购物车" href="shopcart.html"><i></i>加入购物车</a> </div>
      </li>
    </div>
  </div>
  <div class="clear"></div>
...
<div class="am-tabs" data-am-tabs>
  ...
  <div class="am-tabs-bd">
    ...
    <div class="am-tab-panel am-fade">
      ...
      <div class="clear" style="clear:both"><iframe src="footer.html" width="100%" height="150px" frameborder="0" scrolling="no"></iframe></div>
